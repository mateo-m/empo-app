...
switcher, and open it again. [Multi-session](/multi-session) explains why.
...
<Steps>
  ...
  <Step title="Share the log">
    Open the Files app, go to **On My iPhone → Empo**, and share the newest log file.
  </Step>
  <Step title="Open an issue">
    Report it on [GitHub](https://github.com/mateo-m/empo-app/issues) with the title of the game,
    its version, and a description of the failure. You can also ask on

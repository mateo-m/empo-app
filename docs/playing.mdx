...
Each row shows the Empo default until you override it. **Reset to default** puts the default
back, and the reset button in the top right clears every override in the current scope.

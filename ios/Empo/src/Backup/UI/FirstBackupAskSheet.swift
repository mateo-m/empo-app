...
/// sits under them as a standalone sheet, per 3.7.
struct FirstBackupAskSheet: View {
    ...
    var body: some View {
        StandardSheet(
            title: BackupModePicker.askTitle,
            ...
            SheetQuietButton(BackupModePicker.saveFileEditorLabel) { showsTheEditor = true }
        }
